    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="医生编号" prop="yishengUuidNumber">
                        <el-input v-model="yishengForm.yishengUuidNumber"
                                  placeholder="医生编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="医生编号" prop="yishengUuidNumber">
                            <el-input v-model="ruleForm.yishengUuidNumber"
                                      placeholder="医生编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="职业" prop="zhiyeValue">
                        <el-input v-model="yonghuForm.zhiyeValue"
                                  placeholder="职业" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="职业" prop="zhiyeValue">
                            <el-input v-model="ruleForm.zhiyeValue"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约唯一编号" prop="yishengYuyueUuidNumber">
                       <el-input v-model="ruleForm.yishengYuyueUuidNumber"
                                 placeholder="预约唯一编号" clearable  :readonly="ro.yishengYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预约唯一编号" prop="yishengYuyueUuidNumber">
                           <el-input v-model="ruleForm.yishengYuyueUuidNumber"
                                     placeholder="预约唯一编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约理由" prop="yishengYuyueText">
                        <el-input type="textarea"  :readonly="ro.yishengYuyueText" v-model="ruleForm.yishengYuyueText" placeholder="预约理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengYuyueText" label="预约理由" prop="yishengYuyueText">
                            <span v-html="ruleForm.yishengYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="yishengYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yishengYuyueTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.yishengYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengYuyueTime" label="预约时间" prop="yishengYuyueTime">
                            <span v-html="ruleForm.yishengYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yishengYuyueYesnoTypes" label="预约状态" prop="yishengYuyueYesnoTypes">
                        <el-input v-model="ruleForm.yishengYuyueYesnoValue" placeholder="预约状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yishengYuyueYesnoText" label="预约回复" prop="yishengYuyueYesnoText">
                        <span v-html="ruleForm.yishengYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yishengYuyueShenheTime" label="回复时间" prop="yishengYuyueShenheTime">
                        <span v-html="ruleForm.yishengYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yishengYuyueUuidNumber: false,
                    yishengId: false,
                    yonghuId: false,
                    yishengYuyueText: false,
                    insertTime: false,
                    yishengYuyueTime: false,
                    yishengYuyueYesnoTypes: false,
                    yishengYuyueYesnoText: false,
                    yishengYuyueShenheTime: false,
                },
                ruleForm: {
                    yishengYuyueUuidNumber: new Date().getTime(),
                    yishengId: '',
                    yonghuId: '',
                    yishengYuyueText: '',
                    insertTime: '',
                    yishengYuyueTime: '',
                    yishengYuyueYesnoTypes: '',
                    yishengYuyueYesnoText: '',
                    yishengYuyueShenheTime: '',
                },
                yishengYuyueYesnoTypesOptions : [],
                yishengOptions : [],
                yonghuOptions : [],
                rules: {
                   yishengYuyueUuidNumber: [
                              { required: true, message: '预约唯一编号不能为空', trigger: 'blur' },
                          ],
                   yishengId: [
                   ...
                   yishengYuyueText: [
                              { required: true, message: '预约理由不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '申请预约时间不能为空', trigger: 'blur' },
                          ],
                   yishengYuyueTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yisheng_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yishengYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yishengYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yishengYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
