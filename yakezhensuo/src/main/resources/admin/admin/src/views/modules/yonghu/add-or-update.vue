        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="职业" prop="zhiyeTypes">
                        <el-select v-model="ruleForm.zhiyeTypes" :disabled="ro.zhiyeTypes" placeholder="请选择职业">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户邮箱" prop="yonghuEmail">
                       <el-input v-model="ruleForm.yonghuEmail"
                                 placeholder="用户邮箱" clearable  :readonly="ro.yonghuEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
