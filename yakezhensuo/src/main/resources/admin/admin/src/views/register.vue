    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">牙科诊所管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="医生编号" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengUuidNumber" autocomplete="off" placeholder="医生编号"  />
                           </el-form-item>
                        -->
                        ...
                        <el-form-item label="医生手机号" class="input" v-if="tableName=='yisheng'">
                            <el-input v-model="ruleForm.yishengPhone" autocomplete="off" placeholder="医生手机号"  />
                        </el-form-item>
                        ...
                        <!--
                            ...
                            <el-form-item label="医生头像" class="input" v-if="tableName=='yisheng'">
                                    <file-upload
                                        tip="点击上传医生头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="医生邮箱" class="input" v-if="tableName=='yisheng'">
                            <el-input v-model="ruleForm.yishengEmail" autocomplete="off" placeholder="医生邮箱"  />
                        </el-form-item>
                        <!--
                        ...
                        -->
                        <!--
                            <el-form-item label="医生介绍" class="input" v-if="tableName=='yisheng'">
                                <el-input type="textarea" v-model="ruleForm.yishengContent" placeholder="医生介绍"></el-input>
                           </el-form-item>
                        -->
                        <!--
                        ...
                        <!--
                            <el-form-item label="职业" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.zhiyeTypes" autocomplete="off" placeholder="职业"  />
                           </el-form-item>
                        -->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // yisheng 中的 医生编号 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengUuidNumber== null ||this.ruleForm.yishengUuidNumber== "")){
                            ...
                            // }
                            // yonghu 中的 职业 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.zhiyeTypes== null ||this.ruleForm.zhiyeTypes== "")){
...
<style lang="scss" scoped>
	...
	.container {
        ...
        background-image: url(/yakezhensuo/img/back-img-bg.jpg);
