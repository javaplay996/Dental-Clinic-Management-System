               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生编号" prop="yishengUuidNumber">
                       <el-input v-model="ruleForm.yishengUuidNumber"
                                 placeholder="医生编号" clearable  :readonly="ro.yishengUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生姓名" prop="yishengName">
                       <el-input v-model="ruleForm.yishengName"
                                 placeholder="医生姓名" clearable  :readonly="ro.yishengName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生手机号" prop="yishengPhone">
                       <el-input v-model="ruleForm.yishengPhone"
                                 placeholder="医生手机号" clearable  :readonly="ro.yishengPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生身份证号" prop="yishengIdNumber">
                       <el-input v-model="ruleForm.yishengIdNumber"
                                 placeholder="医生身份证号" clearable  :readonly="ro.yishengIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生邮箱" prop="yishengEmail">
                       <el-input v-model="ruleForm.yishengEmail"
                                 placeholder="医生邮箱" clearable  :readonly="ro.yishengEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="医生介绍" prop="yishengContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengContent" label="医生介绍" prop="yishengContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yishengEmail: [
                              { required: true, message: '医生邮箱不能为空', trigger: 'blur' },
                   ...
                   yishengContent: [
                              { required: true, message: '医生介绍不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
