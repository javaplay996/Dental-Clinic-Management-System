    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="病例名称" prop="bingliName">
                       <el-input v-model="ruleForm.bingliName"
                                 placeholder="病例名称" clearable  :readonly="ro.bingliName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="病例名称" prop="bingliName">
                           <el-input v-model="ruleForm.bingliName"
                                     placeholder="病例名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="病例类型" prop="bingliTypes">
                        <el-select v-model="ruleForm.bingliTypes" :disabled="ro.bingliTypes" placeholder="请选择病例类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="病例类型" prop="bingliValue">
                        <el-input v-model="ruleForm.bingliValue"
                            placeholder="病例类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="看病时间" prop="kanbingTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kanbingTime" label="看病时间" prop="kanbingTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="病人自述" prop="bingliZishuText">
                        <el-input type="textarea"  :readonly="ro.bingliZishuText" v-model="ruleForm.bingliZishuText" placeholder="病人自述"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.bingliZishuText" label="病人自述" prop="bingliZishuText">
                            <span v-html="ruleForm.bingliZishuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="诊断结果" prop="bingliZhenduanText">
                        <el-input type="textarea"  :readonly="ro.bingliZhenduanText" v-model="ruleForm.bingliZhenduanText" placeholder="诊断结果"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.bingliZhenduanText" label="诊断结果" prop="bingliZhenduanText">
                            <span v-html="ruleForm.bingliZhenduanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="药方" prop="bingliYaofangText">
                        <el-input type="textarea"  :readonly="ro.bingliYaofangText" v-model="ruleForm.bingliYaofangText" placeholder="药方"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.bingliYaofangText" label="药方" prop="bingliYaofangText">
                            <span v-html="ruleForm.bingliYaofangText"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="花费金额" prop="bingliHuafei">
                       <el-input v-model="ruleForm.bingliHuafei"
                                 placeholder="花费金额" clearable  :readonly="ro.bingliHuafei"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="花费金额" prop="bingliHuafei">
                           <el-input v-model="ruleForm.bingliHuafei"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否缴费" prop="jiaofeiTypes">
                        <el-select v-model="ruleForm.jiaofeiTypes" :disabled="ro.jiaofeiTypes" placeholder="请选择是否缴费">
                            <el-option
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    bingliTypes: false,
                    kanbingTime: false,
                    bingliZishuText: false,
                    bingliZhenduanText: false,
                    bingliYaofangText: false,
                    bingliHuafei: false,
                    jiaofeiTypes: false,
                    insertTime: false,
                },
                ...
                rules: {
                   ...
                   bingliTypes: [
                              { required: true, message: '病例类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   bingliYaofangText: [
                              { required: true, message: '药方不能为空', trigger: 'blur' },
                          ],
                   bingliHuafei: [
